      ...
      },
      {
        ...
        channels: [
          ...
          },
          {
            ...
            label: 'off-topic',
            unread: true,
            description: 'Discussions about topics not related to Next.js or other channels',
            messages: getMessages(),
          },
          {
            id: 23,
          ...
          },
          {
            id: 24,
            label: 'jobs-board',
            description: 'Is your company looking for Next.js developers? Discuss here!',
            messages: getMessages(),
          },
          {
            id: 25,
          ...
          },
          {
            id: 26,
            label: 'makers',
            description: 'Share as you build in public. Welcoming all makers and indie hackers.',
            messages: getMessages(),
          },
          {
            id: 27,
